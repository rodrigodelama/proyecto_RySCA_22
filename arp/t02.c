...
Estructura programa: 
//Creamos la estructura con los campos correspondientes struct arp_frame{};
//Hacemos ARP_resolve int arp_resolve(eth_iface_t * iface,ipv4_addr_t ip_addr, ipv4_addr_t 
ip_addr_src, mac_addr_t mac_addr){ 
--------------------------------------------------------------------------------
//Estructura función 
arp_resolve() int arp_resolve(eth_iface_t * iface,ipv4_addr_t ip_addr, ipv4_addr_t 
ip_addr_src, mac_addr_t mac_addr){ 
...
y=mac_str_addr(dest_MAC,arp_frame.dest_addr_mac); 
